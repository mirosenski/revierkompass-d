...
import { Building2, MapPin, Edit, Trash2, Shield, Target, CheckCircle, XCircle, AlertTriangle } from 'lucide-react';
                ...
                <div className="flex items-center gap-1">
                  {station.notdienst24h && (
                    <div className="flex items-center gap-1 px-1.5 py-0.5 bg-red-100 dark:bg-red-900/30 rounded text-xs">
                      ...
                      <span className="text-red-700 dark:text-red-300 font-bold">24h</span>
                    </div>
                  )}
                  <div className={`flex items-center gap-1 px-1.5 py-0.5 rounded text-xs ${
                    ...
                    <span className="font-bold">{station.isActive ? 'Aktiv' : 'Inaktiv'}</span>
                  </div>
                </div>
              </div>
