...
import { Check, Clock, Info, Save, Shield } from "lucide-react";
	...
	const storageOptions = [
		{
			...
			description:
				"Die Adresse wird nur lokal in Ihrem Browser gespeichert und automatisch gelöscht, wenn Sie die Seite verlassen.",
			icon: Clock,
			color: "blue",
			benefits: [
		...
		},
		{
			...
			description:
				"Die Adresse wird anonymisiert an Administratoren zur Überprüfung gesendet und nach Genehmigung dauerhaft verfügbar.",
			icon: Save,
			color: "green",
			benefits: [
				...
				<div className="flex items-start space-x-3">
					...
					<div className="space-y-2">
						...
						<div className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
							<p>
								<strong>Temporäre Speicherung:</strong> Daten verbleiben
								ausschließlich in Ihrem Browser und werden nicht an externe
								Server übertragen.
							</p>
							<p>
								<strong>Permanente Speicherung:</strong> Nur die Adressdaten
								(Name, Straße, PLZ, Stadt) werden anonymisiert übertragen. Keine
								persönlichen Daten oder IP-Adressen werden gespeichert.
							</p>
						</div>
					</div>
				</div>
