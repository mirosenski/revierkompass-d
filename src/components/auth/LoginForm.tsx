          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            >
              <div className="flex items-center gap-3 mb-2 sm:mb-3">
                ...
                <span className="text-blue-800 dark:text-blue-200 font-medium text-sm">Demo-Zugang</span>
              </div>
              <div className="text-xs sm:text-sm text-blue-700 dark:text-blue-300 mb-2 sm:mb-3">
                <span className="font-mono bg-blue-100 dark:bg-blue-800/30 px-2 py-1 rounded">admin</span> / 
                <span className="font-mono bg-blue-100 dark:bg-blue-800/30 px-2 py-1 rounded">admin123</span>
              </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-green-700 dark:text-green-300 text-xs">Weiterleitung...</p>
                  </div>
                </div>
              </motion.div>
            )}
            ...
            >
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 sm:space-y-4">
                {/* Username Field */}
                <div>
                  <label htmlFor="username" className="block text-sm sm:text-base font-medium text-slate-700 dark:text-slate-300 mb-1 sm:mb-2">
                    Benutzername
                  </label>
                ...
                {/* Password Field */}
                <div>
                  <label htmlFor="password" className="block text-sm sm:text-base font-medium text-slate-700 dark:text-slate-300 mb-1 sm:mb-2">
                    Passwort
                  </label>
                  <div className="relative">
                    <input
