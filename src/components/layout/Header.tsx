...
import { ArrowLeft, LogIn, LogOut, Moon, Settings, Sun } from "lucide-react";
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="flex justify-between items-center h-20">
					...
					<motion.div
						...
						onClick={() => {
							console.log(
								"🔄 Logo geklickt - handleBackToWizard wird aufgerufen",
							);
							onBackToWizard();
						}}
					>
					...
					<div className="flex items-center space-x-4">
						...
						{!isAuthenticated ? (
							...
							<div className="flex items-center space-x-3">
								...
								<motion.div className="hidden sm:flex items-center space-x-2 px-4 py-2 bg-green-100 dark:bg-green-900/30 rounded-xl">
