  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Äußerer Ring */}
        <g className="animated-logo-rotate" style={{
        ...
        <g opacity={isHovered ? "1" : "0.7"} style={{ transition: 'opacity 0.3s ease' }}>
          {/* Nord */}
          <line x1="200" y1="70" x2="200" y2="85" stroke="white" strokeWidth="3" />
          <circle cx="200" cy="70" r="5" fill="white" />
          
          {/* Ost */}
          <line x1="315" y1="200" x2="330" y2="200" stroke="white" strokeWidth="3" />
          <circle cx="330" cy="200" r="5" fill="white" />
          
          {/* Süd */}
          <line x1="200" y1="315" x2="200" y2="330" stroke="white" strokeWidth="3" />
          <circle cx="200" cy="330" r="5" fill="white" />
          
          {/* West */}
          <line x1="70" y1="200" x2="85" y2="200" stroke="white" strokeWidth="3" />
