...
const TestImport: React.FC = () => {
	...
	const handleImport = async () => {
		...
		try {
			...
			setResult(
				`Import abgeschlossen! ${importResult.totalCreated} Stationen erstellt, ${importResult.totalErrors} Fehler.`,
			);
		} catch (error) {
			...
			<div className="max-w-4xl mx-auto">
				...
				<div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
					...
					<p className="text-gray-600 dark:text-gray-400 mb-6">
						Klicken Sie auf den Button, um alle verfügbaren Adressen in die
						Datenbank zu importieren. Der Import kann einige Minuten dauern.
					</p>
