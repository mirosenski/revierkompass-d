...
const initializeApp = () => {
	...
	if (metaDescription) {
		metaDescription.content =
			"RevierKompass - Professionelle Routing-Anwendung für die Polizei Baden-Württemberg. Präzise Navigation zu allen 158 Polizeistationen mit Multi-Provider Routing-Technologie.";
	}
